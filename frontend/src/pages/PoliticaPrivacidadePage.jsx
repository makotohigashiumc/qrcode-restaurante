  ...
  return (
    <div className="min-h-screen bg-gray-50 py-10 px-4">
      <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-sm p-8">
        <div className="mb-6">
          <Link to="/admin/registro" className="text-sm text-beni-mid hover:underline">← Voltar ao cadastro</Link>
        </div>
        ...
        <div className="mt-8 pt-6 border-t text-center">
          <Link
            to="/admin/registro"
            className="bg-beni-mid text-white px-6 py-2.5 rounded-xl font-medium hover:opacity-80 transition-colors"
          >
            ← Voltar ao cadastro
          </Link>
        </div>
